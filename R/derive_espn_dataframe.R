#' Derive the ESPN dataframe
#'
#' ESPN provides just a PDF with the actual inter-position rankings (dollar amounts), so we need to derive
#' this info into a data frame
#'
#' @export
derive_espn_dataframe <- function(cheat_sheet_text = readLines(config::get('espn_cheet_sheet'))) {
